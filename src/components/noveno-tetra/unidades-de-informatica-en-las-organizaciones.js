...
const Unidadesdeinformaticaenlasorganizaciones = () => {
    ...
    return (
        <div class="contenido">
            <h1>Unidades de informatica en las organizaciones</h1>
...
export default Unidadesdeinformaticaenlasorganizaciones;